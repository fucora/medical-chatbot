...
if __name__ == '__main__':
    ...
    res_sql = [{'question_type': 'disease_do_food',
                'sql': ["MATCH (m:Disease)-[r:do_eat]->(n:Food) where m.name = '脑膜炎' return m.name, r.name, n.name",
                        "MATCH (m:Disease)-[r:recommand_eat]->(n:Food) where m.name = '脑膜炎' return m.name, r.name, n.name"]}]
